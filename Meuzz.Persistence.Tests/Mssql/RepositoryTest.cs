...
namespace Meuzz.Persistence.Tests.Mssql
{
    public class RepositoryTest
    {
        ...
        {
            var engine = DatabaseEngineFactory.Instance().CreateEngine("mssql", "Data Source=localhost,1433;Initial Catalog=Persistence;User ID=sa;Password=P@ssw0rd!");
            ...
            ");
            _context.Execute(@"
                INSERT INTO Players VALUES ('red', 10, 100);
                INSERT INTO Players VALUES ('blue', 20, 200);
                INSERT INTO Players VALUES ('green''s', 10, 200);
